...
<template>
  <div v-show="tab === 'content'">
    ...
    <template v-else-if="node.type === 'section'">
      <div class="field"><label>Layout</label><div class="layout-mode"><button :class="{active:(node.layout.mode||'flex')==='flex'}" @click="node.layout.mode='flex'">Flexbox</button><button :class="{active:node.layout.mode==='grid'}" @click="node.layout.mode='grid'">CSS Grid</button></div></div>
      <template v-if="(node.layout.mode||'flex')==='flex'">
        <div class="field"><label>Direction</label><div class="seg"><button :class="{active:node.layout.direction==='row'}" @click="node.layout.direction='row'">Row</button><button :class="{active:node.layout.direction==='column'}" @click="node.layout.direction='column'">Column</button></div></div>
      ...
      <div class="layout-note">Flexbox controls rows, columns, wrapping and distribution. Grid controls explicit columns, rows and gaps.</div>
    </template>
  ...
  <div v-show="tab === 'advanced'">
    ...
    <div class="layout-note">These controls affect this element when its parent is a Flex container. Grid containers primarily control children through the grid columns and rows.</div>
